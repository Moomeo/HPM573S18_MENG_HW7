...
class Cohort:
    def __init__(self, id, pop_size, mortality_prob):
        ...
        self._numdead_5year = 0
        self._percent_5year = 0
    ...
    def simulate(self, n_time_steps):
        ...
        for patient in self._patients:
            ...
            if value <= 5:
                self._numdead_5year += 1 # calculate the number fo patients died within 5 years

        # calculate the percentage of patients survived beyond 5 years
        self._percent_5year = 1-self._numdead_5year/self._initialPopSize
...
class MultiCohort:
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            # store all survival over 5 year percentages for this cohort
            self._percents_5year.append(cohort.get_percent_5yr())
    ...
    def get_percents_5yr(self,cohort_index):
        """:returns: the percentage of patients survived beyond 5 years"""
        return self._percents_5year[cohort_index]